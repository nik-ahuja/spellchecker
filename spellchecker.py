...
################
Description:
The current version of the program asks a verbose input.
# 0: top suggestion
# 1: all suggestions of smallest edit distance
# 2: all suggestions <= max_edit_distance (slower, no early termination)

Then creates a dictionary and go on to ask for word inputs to be corrected.
################
Sample output:
...
# 0: top suggestion
# 1: all suggestions of smallest edit distance
# 2: all suggestions <= max_edit_distance (slower, no early termination) : 0
Creating dictionary...
...
-----
43.45 seconds to create the dictionary
-----
 
Word correction
---------------

Enter your input (or enter to exit): spelign
('spelling', (4, 2))
-----
0.00399 seconds to run
-----
...
def get_suggestions(string, verbose, silent=False):
...
if __name__ == "__main__":
	...
	try:
		...
		create_dictionary("data/big.txt")
	...
	while True:
		...
		if len(word_in)==0:
			...
			break
		start_time = time.time()
		print(get_suggestions(word_in, verbose))
		run_time = time.time() - start_time
		print('-----')
